...
class TestChatlyPoll(FrappeTestCase):
	# 1. Only the poll creator is allowed to view the poll in the Chatly Poll list view.
	...
	# 9. If the poll is anonymous (is_anonymous is checked), all users including the poll creator should not be able to access Chatly Poll
